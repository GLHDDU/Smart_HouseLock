...
{
	IIC_Start();                                       //iic起始信号
	IIC_Send_Byte(0x78);//Slave address,SA0=0          //iic发送OLED地址
	IIC_Wait_Ack();	                                   //应答信号
	IIC_Send_Byte(0x00);//write command                //iic发送-命令-寄存器地址
	IIC_Wait_Ack();	                                   //应答信号
	IIC_Send_Byte(cmd);                                //iic发送命令或数据
	IIC_Wait_Ack();	                                   //应答信号
	IIC_Stop();                                        //iic结束信号
}
...
void write_iic_data(u8 dat)
{
	...
	IIC_Send_Byte(0x78);//Slave address,SA0=0   //iic发送OLED地址
	IIC_Wait_Ack();	                            //应答信号
	IIC_Send_Byte(0x40);//write data            //iic发送-数据-寄存器地址
	IIC_Wait_Ack();	                            //应答信号
	IIC_Send_Byte(dat);                         //iic发送命令或数据
	IIC_Wait_Ack();	                            //应答信号
	IIC_Stop();                                 //iic结束信号
}
...
//x0和x1的差值为图片分辨率的x值，同理，y0和y1的差值为图片分辨率的y值。
