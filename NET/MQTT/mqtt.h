...
#define  PRODUCTKEY           "a1Jij21ILvO"                                 //产品ID
#define  PRODUCTKEY_LEN       strlen(PRODUCTKEY)                            //产品ID长度
#define  DEVICENAME           "D001"                                        //设备名  
#define  DEVICENAME_LEN       strlen(DEVICENAME)                            //设备名长度
#define  DEVICESECRE          "23418849c780750603a344533747c2ae"            //设备秘钥   
#define  DEVICESECRE_LEN      strlen(DEVICESECRE)                           //设备秘钥长度
#define  S_TOPIC_NAME         "/sys/a1Jij21ILvO/D001/thing/service/property/set"   //需要订阅的主题  
#define  P_TOPIC_NAME         "/sys/a1Jij21ILvO/D001/thing/event/property/post"    //需要发布的主题     
